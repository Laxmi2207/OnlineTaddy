...
import { makeStyles } from '@mui/styles';
import tick from './../assets/Ico.png';
...
<Stack direction='column' sx={{ marginLeft: '1rem' }}>
     ...
     >
       <Card sx={{ position: 'absolute', top: '50%', outline:'none',left: '50%', transform: 'translate(-50%, -50%)', width: 600 ,height:'auto'}}>
       <CardHeader
         ...
         {/* <Button sx={{ background: '#00C6FF', borderRadius: '50%', height: '60px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
           ...
           <img src={tick} style={{ width: '100px', height: '70px', align:'center',cursor:'pointer' }} alt="Tick Image" />
         </Typography>
         <Typography sx={{fontWeight:'800',fontFamily:'Nunito Sans',fontSize:'32px',lineHeight:"47.74px",textAlign:'center'}}>We Couldn't Process Your Payment</Typography>

<Typography paragraph sx={{fontWeight:'400',fontFamily:'Nunito Sans',fontSize:'16px',lineHeight:'45px',textAlign:'center'}}>Please try again.</Typography>
